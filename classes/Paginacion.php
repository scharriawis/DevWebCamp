...
class Paginacion{
    ...
    public function __construct($pagina_actual, $registros_por_pagina, $total_registros)
    {
        $this->pagina_actual = (int) $pagina_actual;    //(int) Convierte un valor en int sí es posible
    ...
    public function numeracion_pagina(){
        $html = '';
